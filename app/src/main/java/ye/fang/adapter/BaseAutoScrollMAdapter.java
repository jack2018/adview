...
public abstract class BaseAutoScrollMAdapter<T extends MultiItemEntity, K extends BaseViewHolder> extends BaseMultiItemQuickAdapter<T, K> {
    ...
    public BaseAutoScrollMAdapter(List<T> data) {
        super(data);
    }
